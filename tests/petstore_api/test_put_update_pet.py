...
from models.petstore import PetstoreRequestModelPet, PetstoreRequestModelTag, PetstoreRequestEnumStatus, \
    PetstoreRequestModelCategory
...
@pytest.mark.smoke
def test_put_update_existing_pet_200_valid_data():

    response = PetstoreApi.put_update_existing_pet(
...
def test_put_update_existing_pet_200_photurls_single():
...
def test_put_update_existing_pet_200_photurls_double():
